                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 lg:p-8 mb-8 relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 justify-between items-start md:items-center relative z-10">
                        ...
                        <div className="flex gap-3 flex-wrap items-center">
                            ...
                            <button onClick={loadData} className="px-4 py-2.5 bg-white text-slate-700 border border-slate-300 rounded-lg font-bold hover:bg-slate-50 hover:border-[#1e3a8a] transition shadow-sm">
                                <RefreshCcw size={18} />
                            </button>
                        </div>
                    </div>
                        ...
                        {filteredComplaints.length > 0 ? (
                            filteredComplaints.map(c => (
                                <div key={c.id} className="p-6 bg-white rounded-xl border border-slate-200 hover:shadow-lg hover:border-[#1e3a8a] transition flex flex-col group">
                                    ...
                                    <p className="text-sm text-slate-600 line-clamp-3 mb-6 flex-1 leading-relaxed">{c.description}</p>
