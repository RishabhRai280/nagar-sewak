          ...
          <div className="text-center">
            ...
            >
              ...
              <button
                ...
                className="w-full py-3 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 font-bold transition-all duration-300"
              >
                {t('sendAnother')}
              </button>
            </motion.div>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            ...
            <p className="text-xs text-slate-500 ml-1">{t('emailHint')}</p>
          </motion.div>
