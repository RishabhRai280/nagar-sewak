        ...
        <div className="hidden lg:flex flex-col justify-between p-16 relative overflow-hidden order-1 lg:order-2">
           ...
           <div className="relative z-10">
             <div className="mb-2 flex items-center gap-2">
               ...
               <span className="text-xl font-bold text-emerald-900 tracking-wide">Citizen Portal</span>
             </div>
             ...
             <p className="text-lg text-slate-700 font-medium leading-relaxed">
               Become an active participant in your city's growth. Report issues, track progress, and ensure accountability.
             </p>
           </div>

           <div className="relative z-10 space-y-6 mt-12">
             {[
               { icon: MapPin, title: "Geo-Tagged Reports", desc: "Pinpoint issues with precision" },
               { icon: Shield, title: "Full Accountability", desc: "Rate quality of public works" },
               { icon: Users, title: "Transparent Data", desc: "View budgets & timelines" },
             ].map((item, i) => (
           ...
           <div className="relative z-10 mt-8 flex items-center gap-2 text-sm font-semibold text-slate-600">
             ...
             <span>Join 10,000+ active citizens</span>
           </div>
        </div>
